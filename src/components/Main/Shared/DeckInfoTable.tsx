    ...
    return (
        <tr>
            ...
            {deck === null ? <td className={"edit-td-data"}><a className={"link-pointer"} onClick={() => navigate("/deck/edit", {state: {deck: null}})}>Create...</a></td> :
                <td className={"edit-td-data"}><a className={"link-pointer"} onClick={() => navigate("/quiz", {state: {deck: deck}})}>Quiz!</a> | <a className={"link-pointer"} onClick={() => navigate("/deck/edit", {state: {deck: deck}})}>View/Edit</a></td>}
        </tr>
    );
}
